...
void QuestModalTrue(BuildContext context) {
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SvgPicture.asset('assets/images/popup/man_green_docs.svg'),
            SizedBox(
              height: 8.0,
            ),
            Text(
              'Вірно!',
              style: TextStyle(fontSize: 16.0, color: cGreen),
            ),
            SizedBox(
              height: 8.0,
            ),
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  Navigator.pushNamed(context, '/quest/true_false');
                },
                style: ButtonStyle(
